...
import pandas as pd
import numpy as np
# BASED ON FLERT: Document-Level Features for Named Entity Recognition
from flair.data import Sentence
from flair.models import SequenceTagger
from tqdm import tqdm

# Set up path
BASE_PATH = r"D:\Studium\PhD\Github\Fischerei - Master\Sentiment-Analysis-Western-Baltic-Sea"
...
# load data
data_art = pd.read_csv(r'D:\Studium\PhD\Github\Fischerei - Master\Sentiment-Analysis-Western-Baltic-Sea\Preprocessing\fishery_lemmas_articles.csv') 
